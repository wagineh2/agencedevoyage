...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index2.html">Start Bootstrap</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
            ><!-- Navbar Search-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" style="font-size: 13px;" href="tables.php">Affichage des Partenaires</a><a class="nav-link" style="font-size: 13px;" href="index.html">Ajouts des Partenaires</a></nav>
                            </div>
...
{   
 ...
 $idd= $_GET['idd'];
 $partenaireCvar2 =new partenaireC2();
$listePartenairee2=$partenaireCvar2->afficherPartenairee2($idd);
 }
}
else 
$listePartenairee2=$partenaireCvar2->afficherPartenairee2();
...
foreach($listePartenairee2 as $row){
    ...
    <td><a href="modifierPartenaire2.php?id=<?PHP echo $row['id']; ?>" class="btn btn-warning" style="color:#FFF;">
    Modifier</a></td>
    </tr>
