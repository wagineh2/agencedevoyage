   ...
   <div id="layoutSidenav_content">
                <main style="padding: 30px;">
                    <div class="container-fluid">
                        <h1 class="text-center font-weight-light my-1" style="padding-bottom: 30px;padding-top: 30px;">Gestions des réservations</h1>
                        <center>  
          ...
          <tr>
           ...
           <td><?php echo $row['evenement']; ?></td>
            ...
            <td>
              ...
              <a href="pdf2.php?evenement=<?php echo $row['id']?>"  >
...
{   
 ...
 $acin= $_GET['acin'];
        $query = "SELECT * FROM reservation where id=$acin ";}
