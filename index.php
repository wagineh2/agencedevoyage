...
?>
    ...
    <div class="popular_destination_area">
        <div class="container">
			...
			<?PHP $res = $DB->query('SELECT * FROM res') ;  ?>
			<?PHP foreach ( $res as  $ress) :?>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="res/<?= $ress->photo; ?>" alt="">
                        </div>
                        <div class="content">
                            <p class="d-flex align-items-center"><?PHP echo $ress->destination; ?> <a href="travel_destination.html">  <?PHP echo $ress->nb; ?></a>
								<br><p class="d-flex align-items-center"><a href="confirmation.php?id=<?= $ress->id; ?>"> Reserver</a></p>
